                ...
                if (imageSrc.startsWith('http')) {
                  return (
                    ...
                    <img
                      src={imageSrc}
                      alt={alt || ''}
                      className="max-w-full h-auto rounded mb-4 cursor-zoom-in hover:opacity-95 transition-opacity"
                ...
                return (
                  <div className="relative w-full mb-4">
                    <Image
                      ...
                      width={800}
                      height={600}
                      className="rounded cursor-zoom-in hover:opacity-95 transition-opacity"
                      placeholder="blur"
