...
│   │   └── tabs.tsx         ✗ 탭 컴포넌트
│   ├── shared/              # 공통 컴포넌트
│   │   ├── PostCard.tsx     ✗ 게시글 카드 (메인/커뮤니티 공용)
...
| `/api/main/posts/[id]/like` | POST | 좋아요 토글 | ❌ |
| `/api/main/posts/[id]/bookmark` | POST | 북마크 토글 | ❌ |
